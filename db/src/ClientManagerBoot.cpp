...
{
	if (!InitializeMobTable(g_noTXT))
	{
		sys_err("InitializeMobTable FAILED");
		return false;
	}
	if (!InitializeItemTable(g_noTXT))
	{
...
bool CClientManager::InitializeMobTableTXT(bool sql)
{
	if(!sql) {
		//================== �Լ� ���� ==================//
...
bool CClientManager::InitializeItemTable(bool sql)
{
	if(!sql) 
	{
		//================== �Լ� ���� ==================//
